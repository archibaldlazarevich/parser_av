...
kia_sor_url = ("https://auto.kufar.by/l/cars/kia-sorento?cre="
               ...
               "%2C{max_price}&rgd=r%3A2011%2C2022")
hyundai_url = ('https://auto.kufar.by/l/cars/hyundai-santa-fe-iii'
...
async def parser_kufar_by(
    session: aiohttp.ClientSession, url: str, name: str, min_price: int, max_price: int
):
